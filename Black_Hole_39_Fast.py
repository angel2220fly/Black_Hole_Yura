...
if os.path.basename(sys.argv[0]) != 'Black_Hole_39_Fast.py':
    sys.exit("This is not 'Black_Hole_39_Fast.py'.")

print("The script 'Black_Hole_39_Fast.py' is currently running.")
